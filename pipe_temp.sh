...
echo -e "$(date)Sequence alignment with bowtie2 . . . \n"
...
echo -e "$(date)REMOVE UNMAPPED READS . . . \n"
...
echo -e "$(date)UNMAPPED READS REMOVED. . . \n"
...
echo -e "$(date)FILTERING DUPLICATES . . . . \n"
